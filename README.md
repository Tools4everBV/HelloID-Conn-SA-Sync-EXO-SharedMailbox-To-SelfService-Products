...
| $MicrosoftEntraIDOrganization    | String value of Microsoft Entra ID Organization  | Recommended to set as Global Variable |
| $MicrosoftEntraIDtenantID    | String value of Microsoft Entra ID Tenant ID  | Recommended to set as Global Variable |
| $MicrosoftEntraIDAppId | String value of Microsoft Entra ID App ID  | Recommended to set as Global Variable |
| $MicrosoftEntraIDAppSecret  | String value of Microsoft Entra ID App Secret  | Recommended to set as Global Variable |
